...
GL_PROC(BaseGL, GLenum, glCheckFramebufferStatus, (GLenum a))
GL_PROC(BaseGL, void, glActiveTexture, (GLenum a))
GL_PROC(BaseGL, void, glAttachShader, (GLuint a, GLuint b))
GL_PROC(BaseGL, void, glBindBuffer, (GLenum a, GLuint b))
GL_PROC(BaseGL, void, glBindTexture, (GLenum a, GLuint b))
GL_PROC_EXT(BaseGL, OES, void, glBindVertexArray, (GLuint a))
...
GL_PROC(BaseGL, void, glCompileShader, (GLuint a))
...
GL_PROC(BaseGL, GLuint, glCreateProgram, ())
GL_PROC(BaseGL, GLuint, glCreateShader, (GLenum a))
...
GL_PROC(BaseGL, void, glDrawElements, (GLenum a, GLsizei b, GLenum c, const GLvoid *d))
...
GL_PROC_EXT(BaseGL, OES, void, glGenVertexArrays, (GLsizei a, GLuint *b))
GL_PROC(BaseGL, GLint, glGetAttribLocation, (GLuint a, const GLchar *b))
GL_PROC(BaseGL, GLenum, glGetError, ())
GL_PROC(BaseGL, void, glGetIntegerv, (GLenum a, GLint *b))
GL_PROC(BaseGL, void, glGetProgramInfoLog, (GLuint a, GLsizei b, GLsizei *c, GLchar *d))
GL_PROC(BaseGL, void, glGetProgramiv, (GLuint a, GLenum b, GLint *c))
GL_PROC(BaseGL, void, glGetShaderInfoLog, (GLuint a, GLsizei b, GLsizei *c, GLchar *d))
GL_PROC(BaseGL, void, glGetShaderiv, (GLuint a, GLenum b, GLint *params))
GL_PROC(BaseGL, GLint, glGetUniformLocation, (GLuint a, const GLchar *b))
GL_PROC(BaseGL, void, glLinkProgram, (GLuint a))
...
GL_PROC(BaseGL, void, glShaderSource, (GLuint a, GLsizei b, const GLchar **c, const GLint *d))
...
GL_PROC(BaseGL, void, glUniform1i, (GLint a, GLint b))
GL_PROC(BaseGL, void, glUseProgram, (GLuint a))
...
/* Not present in ES2 */
GL_PROC(NonES2, void, glDrawBuffers, (GLsizei a, const GLenum *b))
GL_PROC(NonES2, void, glDrawRangeElements, (GLenum a, GLuint b, GLuint c, GLsizei d, GLenum e, const GLvoid *f))

/* Needed in order to emulate glBlitFramebuffer in ES2 */
GL_PROC(ES2, void, glGetFramebufferAttachmentParameteriv, (GLenum a, GLenum b, GLenum c, GLint * d))
